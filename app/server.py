...
def start_push(
    ...
    target = registry_host or "registry:5000 (local)"
    _start_job(
        push_saved_images,
  ...
  <div class="wrap">
    ...
    <div class="page active" id="page-downloads">
      ...
      <section style="margin-top:1rem">
        ...
        <input id="pushRegistry" type="text" placeholder="registry.example.com:5000 (empty = local registry:5000)" autocomplete="off" />
        <div class="grid two">
          <div>
        ...
        <p class="hint">
          Uploads every image from the saved <code>images.list</code> / tarballs to the
          registry you specify. Leave the address empty to push to the local Compose registry.
        </p>
      </section>
      <section style="margin-top:1rem">
